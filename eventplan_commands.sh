...
python tasks/generation_models/train.py --data_dir=datasets/event-plan/roc-stories\
 --learning_rate=1e-4 --train_batch_size=256 --eval_batch_size=100 --model_name_or_path=resources/external_models/bart-base \
...
python tasks/generation_models/train.py --data_dir=datasets/event-plan/roc-stories\
 --learning_rate=1e-4 --train_batch_size=64 --eval_batch_size=10 --model_name_or_path=gpt2 \
...
python tasks/generation_models/train.py --data_dir=datasets/event-plan/roc-stories\
 --learning_rate=1e-4 --train_batch_size=128 --eval_batch_size=10 --model_name_or_path=t5-base \
 --output_dir=output/generation_models --model_name leading-to-events-t5 --experiment_name=leading-to-events-t5-roc-stories  \
 --val_check_interval=1.0 --limit_val_batches=10 --max_epochs=5 --accum_batches_args=1 --num_sanity_val_steps=0

# =============================== test ====================
python tasks/generation_models/test.py --data_dir=datasets/event-plan/roc-stories \
...
python tasks/generation_models/train.py --data_dir=datasets/event-plan/roc-stories\
 --learning_rate=1e-4 --train_batch_size=64 --eval_batch_size=10 --model_name_or_path=t5-base \
