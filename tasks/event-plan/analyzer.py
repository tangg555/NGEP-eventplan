...
if __name__ == '__main__':
    ...
    # predictor = load_event_predictor("roc-stories")
    # counter = event_analyzer.event_trainings_nums(predictor)
    # print(counter.most_common(2))

    # # for all stories ===============
    # output_dir = f'{BASE_DIR}/output/event-plan/gen_results_summary'
    # # roc stories
    # retrieve_gen_result(dir_key_words=["leading-plus-event", "roc-stories"],
    #                     file_key_words=["gen.txt"],
    #                     discard_dir_key_words=["leading-to-events"],
    #                     discard_file_key_words=["test_event"],
    #                     result_dir=f'{BASE_DIR}/output/generation_models',
    #                     output_dir=output_dir)
    # retrieve_gen_result(dir_key_words=["leading", "roc-stories"],
    #                     file_key_words=["gen.txt"],
    #                     discard_dir_key_words=["leading-to-events", "leading-plus-events"],
    #                     discard_file_key_words=[],
    #                     result_dir=f'{BASE_DIR}/output/generation_models',
    #                     output_dir=output_dir)
    # print(f"extracted files: {os.listdir(output_dir)}")
    # clean_hint_gen_file(f'{output_dir}/leading-hint-roc-stories.test.source_gen.txt')
    # clean_hint_gen_file(f'{output_dir}/leading-plus-event-hint-roc-stories.test_Seq2seq_event.source_gen.txt')
    # clean_hint_gen_file(f'{output_dir}/leading-plus-event-hint-roc-stories.test_bart_event.source_gen.txt')
    # clean_hint_gen_file(f'{output_dir}/leading-plus-event-hint-roc-stories.test_gpt2_event.source_gen.txt')
    # clean_hint_gen_file(f'{output_dir}/leading-plus-event-hint-roc-stories.test_epb_event.source_gen.txt')
    # clean_hint_gen_file(f'{output_dir}/leading-plus-event-hint-roc-stories.test_predicted_event.source_gen.txt')

    # for all storylines ===============
    output_dir = f'{BASE_DIR}/output/event-plan/storylines_set'
    # roc stories
    retrieve_gen_result(dir_key_words=["leading-to-event", "roc-stories"],
                        file_key_words=["gen.txt"],
                        discard_dir_key_words=["verb"],
                        discard_file_key_words=[],
                        result_dir=f'{BASE_DIR}/output/generation_models',
                        output_dir=output_dir)
    retrieve_gen_result(dir_key_words=["event-plan-bart", "roc-stories"],
                        file_key_words=["gen.txt"],
                        discard_dir_key_words=["verb"],
                        discard_file_key_words=[],
                        result_dir=f'{BASE_DIR}/output/event-plan',
                        output_dir=output_dir)
    print(f"extracted files: {os.listdir(output_dir)}")
