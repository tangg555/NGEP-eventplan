...
def add_customized_args(parser: argparse.ArgumentParser = None):
    ...
    parser.add_argument("--test_event_infix", type=str, default=f"{TEST_EVENT_INFIX}")
...
def add_args_for_pytorch_lightning(parser: argparse.ArgumentParser = None):
    ...
    parser.add_argument('--data_dir', type=str,
                        default=f'{DATASETS_DIR}/{DATA_NAME}',
    ...
    parser.add_argument("--every_n_train_steps", default=10, type=int,
                        help="Number of training steps between checkpoints.")
    parser.add_argument("--save_on_train_epoch_end", action="store_true", default=False, help="save_on_train_epoch_end")
    parser.add_argument("--ckpt_verbose", action="store_true", default=False,
