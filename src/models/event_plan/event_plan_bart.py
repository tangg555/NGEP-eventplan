...
from src.modules.event_plan.datasets import (
    EventPlanDataset,
)
...
class EventPlanBart(BaseTransformer):
    ...
    def _custom_init(self):
        ...
        self._set_up(config=self.config,
                     ...
                     model=self.model)
        self.dataset_class = EventPlanDataset

        self.train_event_infix = "_event"
        self.test_event_infix = self.hparams.test_event_infix if self.hparams.test_event_infix else "_event"
    ...
    def get_dataset(self, src_file_prefix: str, tgt_file_prefix: str) -> EventPlanDataset:
        dataset = self.dataset_class(
            self.tokenizer,
            leading_file_prefix=f"{src_file_prefix}",
            event_file_prefix=tgt_file_prefix,
            max_event_length=self.hparams.max_target_length,
