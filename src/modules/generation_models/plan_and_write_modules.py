...
from src.modules.generation_models.seq2seq_modules import Seq2SeqEncoder, Seq2SeqDecoder, Seq2SeqEncoderForBart

# replace BartModel
class Seq2seqModel(BartModel):
    def __init__(self, config: BartConfig):
        super().__init__(config)
        # =============== mainly customized ===============
        del self.encoder
        self.seq2seq_encoder = Seq2SeqEncoderForBart(config, self.shared)
        # =============== end ===============
        self.post_init()
    ...
    def set_input_embeddings(self, value):
        ...
        self.seq2seq_encoder.embed_tokens = self.shared

    def get_encoder(self):
        return self.seq2seq_encoder
    ...
    def forward(
        ...
        encoder_outputs = self.seq2seq_encoder(
            input_ids=input_ids,
...
class Seq2seqForCG(BartPretrainedModel):
    def __init__(self, config: BartConfig):
        super().__init__(config)
