...
class VerbEventAnnotator(EventExtractor):
        ...
        with open(input_path, "r", encoding="utf-8") as fr, \
            ...
            for line in tqdm(input_lines[existing_size:],
                ...
                for sent_doc in line_doc.sents:
                    ...
                    event_list.append(event.generation_models.strip())
...
if __name__ == '__main__':
    ...
    for dataset_name in ["verb-roc-stories"]:
        event_annotator = VerbEventAnnotator(name=dataset_name,
